= 🔐 Configuración de Confluent Cloud (15 minutos)
...
# Obtener la URL del Bootstrap Server
# Copiar el endpoint (ej: pkc-xxxxx.region.aws.confluent.cloud:9092)
----
...
# Obtener la URL del Schema Registry
confluent schema-registry cluster describe
# Copiar la URL del endpoint (ej: https://psrc-xxxxx.region.aws.confluent.cloud)
----
